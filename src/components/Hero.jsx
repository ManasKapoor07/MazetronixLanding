    ...
    <div id="home" className="bg-slate-50 overflow-hidden">
      <style>{`
        * { font-family: Constantia, 'Palatino Linotype', Palatino, Georgia, serif !important; }
        ...
        @media (max-width: 767px) {
          ...
          .nav-logo-img   { width: 2rem !important; height: 2rem !important; }
      ...
      <nav className="w-full px-6 md:px-16 py-4 flex items-center justify-between bg-white border-b border-slate-100 sticky top-0 z-50 shadow-sm">
        <div className="flex items-center gap-2">
          <img src={logoWhite} alt="Mazetronix Logo" className="nav-logo-img w-30 h-30" />
          <div>
            <div className="nav-logo-title font-display font-700 text-slate-900 text-5xl leading-tight tracking-tight font-bold">MAZETRONIX</div>
            <div className="nav-logo-sub text-2xl text-slate-400 leading-none tracking-widest uppercase font-medium">Solutions</div>
          </div>
        </div>

        {/* Desktop nav links */}
        <div className="hidden md:flex items-center gap-8 text-xl text-slate-600 font-medium">
        ...
        {/* Mobile hamburger */}
        <div className="mobile-menu md:hidden" onClick={() => {
